...
const securityHeaders = [
  {
    ...
    value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' https://placehold.co data:; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://vitals.vercel-insights.com https://api.telegram.org https://nominatim.openstreetmap.org https://*.googleapis.com;".replace(/\s{2,}/g, ' ').trim()
  },
  {
  ...
  },
  {
    ...
    value: "camera=(), microphone=(), geolocation=(self 'https://www.google.com'), payment=()"
  }
];
